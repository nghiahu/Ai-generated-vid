...
| **Task 133** | VDE Redesign HeroLayout in my-video | Phase 33: Hero Layout Editorial Upgrades | `[x]` | `my-video/src/compositions/layouts/opening/HeroLayout.tsx` |
| **Task 135** | Install `lucide-react` in `my-video` project | Phase 34: Intro Briefing Card Refinements | `[x]` | `my-video/package.json` |
| **Task 136** | Refactor `IntroBriefingCardLayout.tsx` | Phase 34: Intro Briefing Card Refinements | `[x]` | `my-video/src/compositions/layouts/opening/IntroBriefingCardLayout.tsx` |
| **Task 137** | Verify and test rendering of the new layout | Phase 34: Intro Briefing Card Refinements | `[x]` | Workspace-wide |
| **Task 138** | Create transcription file for Duy Thanh Nguyen voice sample | Phase 35: Duy Thanh Nguyen Voice Clone | `[x]` | `mp3/Duy Thanh Nguyen/Voice Duy Thanh Nguyen.txt` |
| **Task 139** | Register omnivoice_duythanh key on backend TTS service | Phase 35: Duy Thanh Nguyen Voice Clone | `[x]` | `backend/services/tts.js` |
| **Task 140** | Add selection option to Sidebar config UI | Phase 35: Duy Thanh Nguyen Voice Clone | `[x]` | `frontend/src/components/SidebarConfig.jsx` |
| **Task 141** | Verification & End-to-End Testing | Phase 35: Duy Thanh Nguyen Voice Clone | `[x]` | Workspace-wide |
| **Task 142** | Drop old pronunciation cache, and create tables phoneme_cache and phoneme_alias | Phase 36: Phoneme Agent | `[x]` | `backend/services/db.js` |
| **Task 143** | Implement phoneme.js service (loading local cmudict.dict + Gemini fallback) | Phase 36: Phoneme Agent | `[x]` | `backend/services/phoneme.js` |
| **Task 144** | Integrate Phoneme Agent into ai.js and server.js | Phase 36: Phoneme Agent | `[x]` | `backend/services/ai.js`, `backend/server.js` |
| **Task 145** | Clean up tts.js normalization and update TTS generation | Phase 36: Phoneme Agent | `[x]` | `backend/services/tts.js` |
| **Task 146** | Verify & End-to-End Testing | Phase 36: Phoneme Agent | `[x]` | Workspace-wide |
| **Task 147** | Add voiceover_duration to DB schema and update CRUD mapping | Phase 37: Subtitle & Duration Sync | `[x]` | `backend/services/db.js` |
| **Task 148** | Sync scene durations with actual voiceover audio durations in controllers | Phase 37: Subtitle & Duration Sync | `[x]` | `backend/server.js` |
| **Task 149** | Verify & End-to-End Testing | Phase 37: Subtitle & Duration Sync | `[x]` | Workspace-wide |
| **Task 150** | Create Python Forced Aligner (`align.py`) and Node wrapper (`aligner.js`) | Phase 38: Forced Alignment | `[x]` | `backend/services/` |
| **Task 151** | Migrate DB schema and add `subtitles_json` mapping to `db.js` | Phase 38: Forced Alignment | `[x]` | `backend/services/db.js` |
| **Task 152** | Integrate Forced Alignment into controllers and Remotion components | Phase 38: Forced Alignment | `[x]` | `backend/server.js`, `my-video/` |
| **Task 153** | Verification & End-to-End Testing | Phase 38: Forced Alignment | `[x]` | Workspace-wide |
