...
| Create the UI modal PronunciationModal.jsx | [x] | Build PronunciationModal React component matching user mockup |
| Add trigger button in SidebarConfig.jsx and modal logic in App.jsx | [x] | Connect trigger link and render modal overlay in app |
| End-to-End Verification | [x] | Verify custom pronunciations work successfully on TTS generation |
