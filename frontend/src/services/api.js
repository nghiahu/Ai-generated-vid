...
export const api = {
  ...
  generateStoryboard: async (projectId, scriptText, visualStyle, traits = [], selectedMedia = [], selectedBgMedia = [], selectedCtaMedia = [], options = {}) => {
    const response = await axios.post(`${API_BASE}/projects/${projectId}/generate-storyboard`, { scriptText, visualStyle, traits, selectedMedia, selectedBgMedia, selectedCtaMedia }, options);
    return response.data;
  },
